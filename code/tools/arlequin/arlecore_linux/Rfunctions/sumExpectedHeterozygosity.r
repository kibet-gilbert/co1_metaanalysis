################################################################################
# sumExpectedHeterozygosity function  -  (lines)
# (graphic limited to 32 different populations)
#
...
sumExpectedHeterozygosity <- function(xmlText, timeAttr, outfile=outfiles){
