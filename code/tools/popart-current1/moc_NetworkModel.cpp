...
#include "src/gui/NetworkModel.h"
...
QT_MOC_LITERAL(1, 13, 13), // "traitsUpdated"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12) // "updateTraits"

    },
    "NetworkModel\0traitsUpdated\0\0updateTraits"
};
...
void NetworkModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->traitsUpdated(); break;
        case 1: _t->updateTraits(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (NetworkModel::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkModel::traitsUpdated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NetworkModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_NetworkModel.data,
...
// SIGNAL 0
void NetworkModel::traitsUpdated()
{
